...
Log in at [mcp.factumerit.app](https://mcp.factumerit.app), register your bot, and get your token via email. (Beta registration token required — [join waiting list](https://factumerit.com/waitlist) if you don't have one)
